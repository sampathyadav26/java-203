...
function CreateStudent() {
    ...
    const createstd = async () => {
         StudentService.createStudent(newArr).then((res)=>{
    ...
    return (
        <div className='container'>
            ...
            <div className="mb-3">
                ...
                <input type="text" className="form-control" id="formGroupExampleInput2" value={name} placeholder="Enter your Name" onChange={(e) => setName(e.target.value)} />
            </div>
            <div className="mb-3">
